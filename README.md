...
This is a Todos example app built on the principles described in the [Meteor Guide](http://guide.meteor.com/structure.html). I changed it a litle bit for a project I had to do for my studies. 
